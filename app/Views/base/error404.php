...
<head>
    ...
    <title>KADRY | Nie odnalezino strony</title>
                 ...
                 <div class="row no-gutters align-items-center justify-content-center">
                    <div class="col-md-8 col-lg-6">
                        <div class="text-center">
                            ...
                            <h4 class="error-subtitle mb-4">Ups! Nie odnaleziono strony</h4>
                            <p class="mb-4">Wróć do poprzedniej kub przejdź na stronę główną. </p>
                            <a href="<?= base_url() ?>" class="btn btn-primary font-16"><i class="ri-home-5-line mr-2"></i> Wróć do strony głównej</a>
                        </div>
                    </div>
                </div>
            </div>
